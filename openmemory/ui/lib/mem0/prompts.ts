/**
 * Categorization prompt — port of openmemory/api/app/utils/prompts.py
 */
export const MEMORY_CATEGORIZATION_PROMPT = `Your task is to assign each piece of information (or "memory") to one or more of the following categories. Feel free to use multiple categories per item when appropriate.
